...
//   [BLK06] PARSE (//#region [BLK06] PARSE • Blocos (split/parse/forEach)
splitBlocks, parseBlock, forEachBlock)
//   [BLK07] DATA (catálogo, //#region [BLK07] DATA • Catálogo, URLs e Fetch+Cache
toRawGitHub, fetch+cache)
//   [BLK08] SEARCH (predicados, preview, //#region [BLK08] SEARCH • Predicados, preview, expand, doSearch
expand, doSearch)
//   [BLK09] HIGHLIGHT (//#region [BLK09] HIGHLIGHT • applyHighlights
applyHighlights e afins)
//   [BLK10] RENDER • Cards
    ...
    for (const { url, label } of allOptions) {
      try {
        ...
        if (first) {
          ...
          window.//#region [BLK11] RENDER • Buckets & Results
...
function //#region [BLK10] RENDER • Cards
