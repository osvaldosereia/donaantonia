...
// [SELEÇÃO PARCIAL] — captura texto selecionado e card de origem
...
function buildGeminiQueryFromItem(it) {
  ...
  if (window.__selectionCardId === it.id && window.__selectionText) {
    body = window.__selectionText;
  } else {
    body = String(it.text || "");
